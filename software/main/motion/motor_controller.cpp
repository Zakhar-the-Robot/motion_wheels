...
MotorController::MotorController() : speed(100.0) {}
...
void MotorController::Cmd(MotorControllerCmd_t cmd, uint64_t duration_ms)
{
    ...
    if ((cmd == MotorCmd_Forward) || (cmd == MotorCmd_Backward) || (cmd == MotorCmd_Left) ||
        (cmd == MotorCmd_Right) || (cmd == MotorCmd_Shiver)) {
